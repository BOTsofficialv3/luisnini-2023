...
let str = `
*ミ 𝙷𝙾𝙻𝙰 ✨${taguser}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 𝙳𝙴 𝚃𝙷𝙴 𝐋𝐔𝐈𝐒𝐍𝐈𝐍𝐈𝐁𝐎𝐓𝐙ᙆ  ᷦ×͜× -彡*
...
mediaType: 'VIDEO',
mediaUrl: null,
title: '👑 𝐋𝐔𝐈𝐒𝐍𝐈𝐍𝐈𝐁𝐎𝐓𝐙ᙆ  ᷦ×͜× - 𝐁𝐎𝐓 👑',
body: null,
thumbnail: img,
sourceUrl: `https://chat.whatsapp.com/IKIivfwnnP7F9jbX1PTggb`
}}}
...
° ඬ⃟👑 _${usedPrefix}listprem_
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'tiktok.com/@fenix_bot57', 'youtuber', '𝕱é𝖓𝖎𝖝 𝖇𝖔𝖙 +57', 'grupo', [
['📮 𝙳𝙾𝙽𝙰𝚁 📮', '/donasi'],
['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '/owner'],
['🐾 𝙸𝙽𝙵𝙾𝙱𝙾𝚃 🐾', '/infobot']
], m,)
